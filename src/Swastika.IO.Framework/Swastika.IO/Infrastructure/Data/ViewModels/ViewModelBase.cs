...
#pragma warning disable CS1998 // Override optional
        ...
        public ViewModelBase(TModel model, TDbContext _context = null, DbContextTransaction _transaction = null)
        {
            this.Model = model;
            ParseView(_context: _context, _transaction: _transaction);

        }
        public ViewModelBase(TModel model, bool isLazyLoad, TDbContext _context = null, DbContextTransaction _transaction = null)
        {
            this.Model = model;

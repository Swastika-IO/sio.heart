...
namespace Swastika.Infrastructure.Data.Repository
{
        ...
        where TModel : class where TView : ViewModelBase<TModel, TView> where TContext : DbContext
    {
        ...
        /// </returns>
        public virtual bool CheckIsExists(TView entity, TContext _context = null, DbContextTransaction _transaction = null)
        {
        ...
        /// </returns>
        public bool CheckIsExists(System.Func<TModel, bool> predicate, TContext _context = null, DbContextTransaction _transaction = null)
        {
            TContext context = _context ?? InitContext();
            var transaction = _transaction ?? context.Database.BeginTransaction();
            try
        ...
        public virtual RepositoryResponse<TView> CreateModel(TView view, bool isSaveSubModels = false
            , TContext _context = null, DbContextTransaction _transaction = null)
        {
            TContext context = _context ?? InitContext();
            var transaction = _transaction ?? context.Database.BeginTransaction();
            try
        ...
        public virtual bool SaveSubModel(TView view, TContext context, DbContextTransaction _transaction)
        {
            return false;
        }
        ...
        /// <param name="model">The model.</param>
        /// <returns></returns>
        public virtual Task<bool> SaveSubModelAsync(TView view, TContext context, DbContextTransaction _transaction)
        {

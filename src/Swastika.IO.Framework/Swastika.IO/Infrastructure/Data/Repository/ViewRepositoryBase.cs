...
namespace Swastika.Infrastructure.Data.Repository
{
        ...
        where TDbContext : DbContext
    {
        ...
        /// </returns>
        public virtual bool CheckIsExists(TModel entity, TDbContext _context = null, DbContextTransaction _transaction = null)
        {
        ...
        /// <param name="isGetSubModels">if set to <c>true</c> [is get sub Items].</param>
        /// <returns></returns>
        public virtual async Task<RepositoryResponse<List<TView>>> GetModelListByAsync(
        ...
        public virtual async Task<RepositoryResponse<PaginationModel<TView>>> GetModelListByAsync(
            ...
            , OrderByDirection direction, int? pageSize = null, int? pageIndex = null
            , TDbContext _context = null, DbContextTransaction _transaction = null)
        {
            var context = _context ?? InitContext();
            var transaction = _transaction ?? context.Database.BeginTransaction();
        ...
        /// <param name="predicate">The predicate.</param>
        /// <returns></returns>
        public virtual async Task<RepositoryResponse<bool>> RemoveModelAsync(
            Expression<Func<TModel, bool>> predicate
            , TDbContext _context = null, DbContextTransaction _transaction = null)

...
namespace Swastika.Domain.Data.ViewModels
{
    ...
    public abstract class EcmViewModelBase<TDbContext, TModel, TView>
        where TDbContext : DbContext
        where TModel : class
        where TView : EcmViewModelBase<TDbContext, TModel, TView> // instance of inherited
    {
        #region Properties
        ...
        [JsonIgnore]
        public static readonly EcmDefaultRepository<TDbContext, TModel, TView> Repository;        

        static EcmViewModelBase()
        {
            Repository = EcmDefaultRepository<TDbContext, TModel, TView>.Instance;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EcmViewModelBase{TDbContext, TModel, TView}"/> class.
        /// </summary>
        /// <param name="model">The model.</param>
        /// <param name="_context">The context.</param>
        /// <param name="_transaction">The transaction.</param>
        protected EcmViewModelBase(TModel model, TDbContext _context = null, IDbContextTransaction _transaction = null)
        {
            this.Model = model;
        ...
        /// <param name="_context">The context.</param>
        /// <param name="_transaction">The transaction.</param>
        protected EcmViewModelBase(TModel model, bool isLazyLoad, TDbContext _context = null, IDbContextTransaction _transaction = null)
        {
            this.Model = model;
